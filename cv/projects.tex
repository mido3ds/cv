...
%---------------------------------------------------------
  ...
  \cventry
  {Developer} % Role
  {Graduation Project -- C4IAN \tiny{\href{https://www.github.com/mido3ds/C4IAN}{Repo}}} % Event
  {} % Location
  {Feb-Jul 2021} % Date(s)
  {
  ...
  \cventry
    {Back-end Developer} % Role
    {Mini-Search-Engine \tiny{\href{https://github.com/mido3ds/mini-search-engine/}{Repo}}} % Event
    {} % Location
    {Feb 2020} % Date(s)
    {
      \begin{cvitems} % Description(s)
  ...
  \cventry
    ...
    {Match Reservation System \tiny{\href{https://github.com/mido3ds/match-reservation-system}{Repo}}} % Event
    {} % Location
    {Jan 2021} % Date(s)
    {
      \begin{cvitems} % Description(s)
